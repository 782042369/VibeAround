...
VibeAround 是 AI 编程代理的统一运行时。它将真正的编程代理（Claude Code、Gemini CLI、Codex CLI、Cursor CLI、Kiro CLI、Qwen Code、OpenCode）接入你日常使用的每个界面：桌面应用、浏览器、Telegram、飞书、Discord、Slack、微信、钉钉、企业微信、QQ。不是套壳 — 是一个完整的运行时，支持流式输出、工具调用和思考过程展示。
...
- **IM 频道** — Telegram、飞书、Discord、Slack、微信、钉钉、企业微信、QQ — 每个都是独立插件
