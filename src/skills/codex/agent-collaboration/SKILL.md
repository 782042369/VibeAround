...
description: "Codex only: initialize and wait for VibeWbz Codex subagents in a multi-agent coding turn. Use when the user's message starts with \"subagent=\", especially \"subagent=parallel\"."
---
